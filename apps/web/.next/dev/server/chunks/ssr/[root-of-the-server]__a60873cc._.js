...
"[project]/apps/web/actions/schedule-teaching.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40c8cfc30a042c2ce257e8d4e5789b44fdf3c7c763":"getTeachingStats","40e83e70252f715ce20dd37b44f33d0af5e89e819b":"recalculateAllTeachingLoads","40e9af18d61f6e4d857b4c618658c6f430d76e7a90":"getTeachingLoads","6097a8fc8f35c7d77bca35c370d572deffd3fe424e":"approveTeachingLoad","60cf0d871db9a1ea83a674e6ab8c35f0a8c904bdc8":"getInstructorSchedule","60e9a08d7d48e080a209f66cf925a0000de8221610":"calculateTeachingLoad"},"",""] */ __turbopack_context__.s([
    "approveTeachingLoad",
    ()=>approveTeachingLoad,
...
;
;
async function getTeachingLoads(filters) {
    try {
        const where = {};
        if (filters?.termId) {
        ...
        const loads = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$lib$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].teachingLoad.findMany({
            where,
            include: {
                instructor: {
                    select: {
        ...
        return {
            success: false,
            error: "Failed to fetch teaching loads"
        };
    }
}
async function getTeachingStats(termId) {
    try {
        const where = termId ? {
            termId
        } : {};
        const [activeInstructors, totalLoads] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$lib$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].teachingLoad.findMany({
                where,
                distinct: [
                    "instructorId"
                ],
        ...
        const avgHours = totalLoads.length > 0 ? totalLoads.reduce((sum, load)=>sum + Number(load.totalHours), 0) / totalLoads.length : 0;
        const totalCourses = totalLoads.reduce((sum, load)=>sum + load.courseCount, 0);
        // Count overloaded instructors (>18 hours)
        const overloaded = totalLoads.filter((load)=>Number(load.totalHours) > 18).length;
        return {
            success: true,
            stats: {
...
async function calculateTeachingLoad(instructorId, termId) {
    try {
        ...
        const existingLoad = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$lib$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].teachingLoad.findUnique({
            where: {
                instructorId_termId: {
                    instructorId,
                    termId
        ...
        let teachingLoad;
        if (existingLoad) {
            teachingLoad = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$lib$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].teachingLoad.update({
                where: {
                    id: existingLoad.id
                },
                data: {
            ...
            teachingLoad = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$lib$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].teachingLoad.create({
                data: {
                    instructorId,
                    termId,
                    lectureHours,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/admin/schedule/teaching");
        return {
            success: true,
            teachingLoad
        };
        ...
        return {
            success: false,
            error: "Failed to calculate teaching load"
        };
    }
}
async function approveTeachingLoad(id, approvedBy) {
    try {
        const teachingLoad = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$lib$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].teachingLoad.update({
            where: {
                id
            },
            data: {
        ...
        return {
            success: false,
            error: "Failed to approve teaching load"
        };
    }
}
async function getInstructorSchedule(instructorId, termId) {
    try {
        const where = {
            instructorId
        };
...
async function recalculateAllTeachingLoads(termId) {
    try {
        ...
        const instructorIds = schedules.map((s)=>s.instructorId).filter((id)=>id !== null);
        // Calculate for each instructor
        const results = await Promise.all(instructorIds.map((instructorId)=>calculateTeachingLoad(instructorId, termId)));
        ...
        return {
            success: false,
            error: "Failed to recalculate teaching loads"
        };
    }
}
;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getTeachingLoads, "40e9af18d61f6e4d857b4c618658c6f430d76e7a90", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getTeachingStats, "40c8cfc30a042c2ce257e8d4e5789b44fdf3c7c763", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(calculateTeachingLoad, "60e9a08d7d48e080a209f66cf925a0000de8221610", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(approveTeachingLoad, "6097a8fc8f35c7d77bca35c370d572deffd3fe424e", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getInstructorSchedule, "60cf0d871db9a1ea83a674e6ab8c35f0a8c904bdc8", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(recalculateAllTeachingLoads, "40e83e70252f715ce20dd37b44f33d0af5e89e819b", null);
}),
"[project]/apps/web/.next-internal/server/app/admin/schedule/teaching/page/actions.js { ACTIONS_MODULE0 => \"[project]/apps/web/actions/translation.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/apps/web/actions/admin-auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/apps/web/actions/settings.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/apps/web/actions/schedule-teaching.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$schedule$2d$teaching$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/actions/schedule-teaching.ts [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/apps/web/.next-internal/server/app/admin/schedule/teaching/page/actions.js { ACTIONS_MODULE0 => \"[project]/apps/web/actions/translation.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/apps/web/actions/admin-auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/apps/web/actions/settings.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/apps/web/actions/schedule-teaching.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "40c8cfc30a042c2ce257e8d4e5789b44fdf3c7c763",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$schedule$2d$teaching$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTeachingStats"],
    "40e83e70252f715ce20dd37b44f33d0af5e89e819b",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$schedule$2d$teaching$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["recalculateAllTeachingLoads"],
    "40e9af18d61f6e4d857b4c618658c6f430d76e7a90",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$schedule$2d$teaching$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTeachingLoads"],
    "6097a8fc8f35c7d77bca35c370d572deffd3fe424e",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$schedule$2d$teaching$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["approveTeachingLoad"],
    "60cf0d871db9a1ea83a674e6ab8c35f0a8c904bdc8",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$schedule$2d$teaching$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getInstructorSchedule"],
    "60e9a08d7d48e080a209f66cf925a0000de8221610",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$schedule$2d$teaching$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateTeachingLoad"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f2e$next$2d$internal$2f$server$2f$app$2f$admin$2f$schedule$2f$teaching$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$apps$2f$web$2f$actions$2f$translation$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$apps$2f$web$2f$actions$2f$admin$2d$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$apps$2f$web$2f$actions$2f$settings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$apps$2f$web$2f$actions$2f$schedule$2d$teaching$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/apps/web/.next-internal/server/app/admin/schedule/teaching/page/actions.js { ACTIONS_MODULE0 => "[project]/apps/web/actions/translation.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/apps/web/actions/admin-auth.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/apps/web/actions/settings.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/apps/web/actions/schedule-teaching.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$translation$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/actions/translation.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$admin$2d$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/actions/admin-auth.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$settings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/actions/settings.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$actions$2f$schedule$2d$teaching$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/actions/schedule-teaching.ts [app-rsc] (ecmascript)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a60873cc._.js.map