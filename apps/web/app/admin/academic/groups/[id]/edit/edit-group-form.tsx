...
import { updateStudentGroup } from "@/actions/student-group";
...
export function EditGroupForm({ group, programs, instructors, yearOptions }: EditGroupFormProps) {
    ...
    function handleSubmit(e: React.FormEvent) {
        ...
        startTransition(async () => {
            const result = await updateStudentGroup(group.id, {
